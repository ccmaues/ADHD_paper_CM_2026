...
fig4 <-
	ggplot(scree_data, aes(x = PC, y = var_exp_pct)) +
		...
		geom_text(aes(label = paste0(round(var_exp_pct, 2), "%")), vjust = -1.5, color = "black", size = 4, angle = 25) +
...
ggsave("supp_fig1.png", final, device = "png", height = 300, width = 200, units = "mm")
